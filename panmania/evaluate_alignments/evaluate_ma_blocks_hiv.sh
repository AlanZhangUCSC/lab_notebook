...
#SBATCH --job-name=hiv_ma_blocks_correction
...
data_dir=data/hiv
output_file=out/hiv20000_alignment_exepcted_correction.tsv
...
process_pair() {
    ...
    blocks_range_file=data/hiv/hiv20000_block_ranges.tsv
