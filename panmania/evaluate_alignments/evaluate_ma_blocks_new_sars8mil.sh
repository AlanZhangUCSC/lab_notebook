...
#SBATCH --job-name=sars8mil_ma_blocks_correction_new_panman
...
pairs_tsv=/private/groups/corbettlab/alan/panmania/panman/panmans/sars8mil_sequences/selected_pairs.tsv
data_dir=/private/groups/corbettlab/alan/panmania/panman/panmans/sars8mil_sequences/
output_file=out/sars8mil_alignment_exepcted_correction_new_panman.tsv
