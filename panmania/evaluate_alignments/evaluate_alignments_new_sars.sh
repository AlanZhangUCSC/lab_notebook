...
#SBATCH --job-name=new_sars_evaluate_alignments
...
pairs_tsv=data/sars/sars20000_pairs_new.tsv
data_dir=data/sars
output_file=out/sars20000_alignment_differences_new.tsv
...
process_pair() {
    ...
    unaligned_parent_path="$data_dir/sars20000_fasta_unaligned/$parent_cleaned.fasta"
    unaligned_child_path="$data_dir/sars20000_fasta_unaligned/$child_cleaned.fasta"
    aligned_parent_path="$data_dir/sars20000_fasta_aligned/$parent_cleaned.fasta"
    aligned_child_path="$data_dir/sars20000_fasta_aligned/$child_cleaned.fasta"
