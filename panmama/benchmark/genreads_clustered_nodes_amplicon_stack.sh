...
OUT_PREFIX="/data/tmp/${PREFIX_BASE}"
...
if [[ "$SEQTYPE" == "shotgun" ]]; then
  ...
  python3 /private/home/bzhan146/tools/trim_and_stack_amplicon.py  stack \
    $sorted_bam \
    /private/home/bzhan146/tools/SWAMPy/primer_sets/nimagenV2.bed \
    -o ${OUT_PREFIX}.amplicon_stacks.tsv
  ...
  python3 /private/home/bzhan146/tools/trim_and_stack_amplicon.py trim \
    $trimmed_sorted_bam \
    -o ${OUT_PREFIX}.trimmed.fastq
