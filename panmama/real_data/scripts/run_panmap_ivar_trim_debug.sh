...
RSV_A_primer_bed_file=$data_dir/other_files_you_might_need/SVA.primer.bed
RSV_B_primer_bed_file=$data_dir/other_files_you_might_need/SVB.primer.bed
...
rsv_dir=$data_dir/${rsv_samples[0]}
...
bwa mem -t 8 ${RSV_A_ref_fasta} ${A_R1_file} ${A_R2_file} | samtools sort --threads 8 | samtools view --threads 8 -F 4 -o ${sorted_A_bam} &
bwa mem -t 8 ${RSV_B_ref_fasta} ${B_R1_file} ${B_R2_file} | samtools sort --threads 8 | samtools view --threads 8 -F 4 -o ${sorted_B_bam} &
wait
